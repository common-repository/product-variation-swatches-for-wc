<?php	
	...
	if ( ! class_exists( 'Woocommerce_Variation_Swatches_Export_Import' ) ):
		
		class Woocommerce_Variation_Swatches_Export_Import {
			...
			public function __construct() {
				...
				//add_filter( 'woocommerce_product_export_column_names', 'add_woocommerce_variation_gallery_export_column' );
			...
			public function default_import_column_name( $columns ) {
				...
				$columns[ esc_html__( 'Swatches Attributes', 'woocommerce-variation-gallery' ) ] = $this->column_id;
		...
		new Woocommerce_Variation_Swatches_Export_Import();
	endif;