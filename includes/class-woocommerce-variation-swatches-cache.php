<?php
	 ...
	 * How to use:
	 *
	 * $cache  = new Woocommerce_Variation_Swatches_Cache( 'name', 'group' );
	 ...
	 * echo $results;
	 *
	 * print_r( Woocommerce_Variation_Swatches_Cache::get_transients() );
	 */
	
	
	if ( ! class_exists( 'Woocommerce_Variation_Swatches_Cache' ) ) {
		class Woocommerce_Variation_Swatches_Cache {
